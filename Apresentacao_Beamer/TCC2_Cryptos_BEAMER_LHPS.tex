...
\include{CONFIGS_BEAMER} 	
\include{PROGRESS_BAR_CONFIG}
...
\begin{center}
	...
	\begin{minipage}{0.5\linewidth}
		\begin{figure}
			\centering
			%\includegraphics[width=0.3\linewidth]{github.png}
			\includegraphics[width=0.3\linewidth]{github_qrcode.png}
		\end{figure}
	\end{minipage}
\end{center}
...
%			\begin{tikzpicture}%
%				\node (0,0) {\bfseries\Large};%
%				\node  [opacity=0.2]{\includegraphics[width = 0.1\linewidth]{brazil.png}};%
%				\hfill
%				\node  [opacity=0.2]{\includegraphics[width = 0.1\linewidth]{US.png}};%
%				\hfill
%				\node  [opacity=0.2]{\includegraphics[width = 0.1\linewidth]{spain.png}};%
%				\hfill
%				\node  [opacity=0.2]{\includegraphics[width = 0.1\linewidth]{southkorea.png}};%
%			\end{tikzpicture}
%		\end{minipage}
				...
				\begin{minipage}{0.7\linewidth}
				\includegraphics[width = 0.1\linewidth]{brazil.png}
				\hfill
				\includegraphics[width = 0.1\linewidth]{US.png}
				\hfill
				\includegraphics[width = 0.1\linewidth]{spain.png}
				\hfill
				\includegraphics[width = 0.1\linewidth]{southkorea.png}
				\end{minipage}
		\end{center}
